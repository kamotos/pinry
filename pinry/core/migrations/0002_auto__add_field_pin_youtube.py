...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pin.youtube'
        db.add_column(u'core_pin', 'youtube',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pin.youtube'
        db.delete_column(u'core_pin', 'youtube')
    ...
    models = {
        ...
        u'core.pin': {
            ...
            'youtube': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'})
        },
